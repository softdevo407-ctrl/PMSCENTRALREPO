...
public class ProjectCategoryRequest {
    ...
    public ProjectCategoryRequest(String projectCategoryCode, String projectCategoryFullName,
                                 String projectCategoryShortName, String showOnDashboard, Integer hierarchyOrder,
                                 LocalDate fromDate, LocalDate toDate, String userId, String regStatus) {
